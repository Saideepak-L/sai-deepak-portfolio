...
- `index.html` — personal portfolio homepage centred on real working projects and implementation evidence
- `styles.css` - portfolio design system, responsive layouts, and native scroll-linked animation
- `script.js` - mobile navigation, email copy action, and progressive reveal behaviour
- `projects/garage.html` - Forge & Field live concept
- `projects/cleaning.html` - Evergreen Workplace live concept
- `projects/dental.html` - Aster House Dental live concept
- `projects/project.css` - shared concept-site styling
